function dynamischEventUebersicht(){
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            var inhalt = "<section id='uebersichtSection'><table id='eventnameUebersicht'><tr><td> <b>Eventname:</b> " + data.eventname + "</td> <td> <b>Ort:</b> " + data.ort + "</td> <td> <b>Zeit:</b> " + data.zeit 
