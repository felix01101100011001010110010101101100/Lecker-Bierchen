    ...
    $.ajax({
        ...
        success: function(data){
            ...
            data.forEach(function(event){
                ...
                + "</td><td> <b>Gruppe:</b> "+ event.gruppenname + "</td><td> <b>Fahrer:</b> </td><td colspan='8'><i id='eventEntfernen' class='fa-solid fa-xmark'></td> <tr><td colspan='12' id='beschreibung'>Beschreibung: "+ 
